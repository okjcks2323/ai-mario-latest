...
function start(){
  GameStatus="start";
  document.getElementById("status").innerHTML="Game is loading null";
}
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press play button to start the GAME(BY muskmelon) ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
